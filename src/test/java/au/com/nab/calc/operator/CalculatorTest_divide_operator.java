...
public class CalculatorTest_divide_operator {
    ...
    public static Collection<Object[]> data() throws Exception {
        return TEST_DATA_DIVIDE;
    }

    @BeforeClass
    public static void setUp() throws Exception {
        // Setup a Calculator with support for BigDecimal operands and setting Divide Operator
