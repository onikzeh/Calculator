...
public class CalculatorTest_multiply_operator {
    ...
    public static Collection<Object[]> data() throws Exception {
        return TEST_DATA_MULTIPLY;
    }

    @BeforeClass
    public static void setUp() throws Exception {
        // Setup a Calculator with support for BigDecimal operands and setting Multiply Operator
